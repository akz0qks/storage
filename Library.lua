...
-- Library init
    ...
    local Fonts = {}; do
        ...
        local ProggyClean Small Regular = RegisterFont("Proggy Clean", 400, "Normal", {
            Id = "ProggyClean.ttf",
            Font = game:HttpGet("https://github.com/akz0qks/storage/raw/refs/heads/main/fonts/ProggyClean.ttf"),
        })

        Library.Font = Font.new(ProggyClean, Enum.FontWeight.Regular, Enum.FontStyle.Normal);
    end
--
